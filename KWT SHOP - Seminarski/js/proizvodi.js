...
{
    var trazeno = document.getElementById("trazi").value;
   // var navTrazeno = document.getElementById("navPretraga").value;
    var dostupno = document.getElementById("vrsta").value;
    var el = document.getElementById("sviProizvodi");
    while ( el.firstChild ) el.removeChild( el.firstChild );
    
    for(var i=0; i<naziv.length; i++)
	{
   if((naziv[i].match(trazeno)) && (dostupno=="Svi" || vrsta[i]==dostupno))
   {
	var div = document.createElement("div");
		var divButton = document.createElement("div");
		div.setAttribute("class","proizvod");
